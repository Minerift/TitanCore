package org.vexar.titan.modules.enchanter.util;
...
public class EnchantScript implements IconScript, Listener {
    ...
    public void onEnchant(EnchantItemEvent e) {
        if(e.getView().equals(inventoryView)) {
            ...
            if(vexarProfile.getTickets() >= level.getLevel(e.whichButton())) {
                vexarProfile.setTickets(vexarProfile.getTickets() - level.getLevel(e.whichButton()));
            } else {
